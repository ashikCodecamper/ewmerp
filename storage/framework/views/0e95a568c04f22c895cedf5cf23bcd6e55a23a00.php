<?php $__env->startSection('module-name','Pending :: Shipment '); ?>
...
<div class="row">
  <div class="col-12">
    <div class="row">
      &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo e(route('vessel.approval')); ?>" class="pull-right btn btn-success">Vessel List</i></a>
      <div class="col-1">
                  ...
                  <?php $__currentLoopData = $polists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $polist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   ...
                   <tr>
                      <td><?php echo e($loop->iteration); ?></td>
                       ...
                       <td width="15%"><?php echo e($polist->supplier_name); ?></td>
                       <td><?php echo e($polist->proto); ?></td>
                        <td><?php echo e($polist->style_code); ?></td>
                         <td width="15%"><?php echo e($polist->prdct_des); ?></td>
                          <td><?php echo e($polist->quantity); ?></td>
                           <td><?php echo e($polist->sea_name); ?></td>
                           
                             <td><?php echo e($polist->color); ?></td>
                              <td><?php echo e($polist->ex_factory_date); ?></td>
                               <td>
                                 <a href="#" data-id="<?php echo e($polist->id); ?>" class="btn btn-danger rvlist" data-toggle="tooltip" title="Log!"><i class="fa fa-plus"></i></a>
