       ...
       <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools" style="float:right;">
                      <a href="<?php echo e(route('seal03.index')); ?>"><button type="buton" class="btn bg-purple btn-lg" ><strong>List<strong></button></a>
              </div>
              <hr>
            </div>
            <form method="post" action="<?php echo e(route('seal03.store')); ?>" data-parsley-validate>
    ...
    let submitted_date = moment($("#actsubdate").val());
      ...
      $.ajax({
        ...
        success: function(result){
          ...
          var approval_date = exfactory_date.subtract(45, 'days');
          $("#targetdate").html("Red/Dev. sample Approval target date: <br> " + approval_date.format('YYYY-MM-DD'))
          console.log("approval date(exfactory_date- 45) => ", approval_date.format('YYYY-MM-DD'));
