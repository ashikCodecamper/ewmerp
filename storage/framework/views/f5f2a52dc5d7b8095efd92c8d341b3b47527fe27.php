<?php $__env->startSection('module-name','PCP :: Red/Dev Sample'); ?>
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools" style="float:right;">
                  ...
                  <a href="<?php echo e(route('seal01.create')); ?>"><button type="buton" class="btn bg-purple btn-lg" ><strong>Add New Seal<strong></button></a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <table class="table">
                ...
                <tr>
                  ...
                  <td><?php echo e($sealone->seal_type); ?></td>
                  <td><?php echo e(date( 'jS M Y', strtotime($sealone->plan_date))); ?></td>
                  <td><?php echo e(date('jS M Y', strtotime($sealone->submission_date))); ?></td>
                  <td><?php echo e($sealone->awb_details); ?></td>
                  <td><?php echo e($sealone->comment); ?></td>
                  <td><?php echo e(date('jS M Y', strtotime($sealone->comment_date))); ?></td>
                  <td><?php echo e($sealone->rev_comment); ?></td>


                  <td class="text-right">
                    <?php if($sealone->status): ?>
                      <a href="<?php echo e(route('seal01.approve', ['id'=>$sealone->id])); ?>"><span class="btn label-warning">undo approve</span></a>
                    <?php else: ?>
                      <a href="<?php echo e(route('seal101.edit', ['id'=>$sealone->id])); ?>"><span class="btn label-warning">edit</span></a>
                      <a href="<?php echo e(route('seal01.approve', ['id'=>$sealone->id])); ?>"><span class="btn label-success">approve</span></a>
                      <a href="<?php echo e(route('seal01.reject', ['id'=>$sealone->id])); ?>"><span class="btn label-primary">reject</span></a>
    ...
    <script type="text/javascript">
      $('document').ready(function () {
        $('.mshit').click(function () {
          ...
          axios.get('<?php echo e(route('seal01.rejectlog')); ?>',{
            params: {
              id: this.id
            }
          }).then(function (res) {
