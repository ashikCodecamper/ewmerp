        ...
        <div class="box-header">
           <h3 class="box-title">Supplier</h3>
              ...
              <div class="box-tools" style="float:right;">
                  <a href="<?php echo e(route('cmpHome')); ?>"><button type="buton" class="btn bg-purple btn-lg" ><strong>compliance list</strong></button></a>
              </div>
              <hr>
        </div>
      
      <form class="" method="post" action="<?php echo e(route('supplierStore')); ?>" enctype="multipart/form-data" data-parsley-validate>
