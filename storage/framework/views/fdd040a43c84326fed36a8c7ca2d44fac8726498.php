          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools" style="float:right;">
                  ...
                  <a href="<?php echo e(route('seal03.create')); ?>"><button type="buton" class="btn bg-purple btn-lg" ><strong>Add New Seal<strong></button></a>
              </div>
            </div>
            <!-- /.box-header -->
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <?php if($sealone->status): ?>
                      <a href="<?php echo e(route('seal03.approve', ['id'=>$sealone->id])); ?>"><span class="btn label-warning">undo approve</span></a>
                    <?php else: ?>
                      <a href="<?php echo e(route('seal03.edit', ['id'=>$sealone->id])); ?>"><span class="btn label-warning">edit</span></a>
                      <a href="<?php echo e(route('seal03.approve', ['id'=>$sealone->id])); ?>"><span class="btn label-success">approve</span></a>
                      <a href="<?php echo e(route('seal03.reject', ['id'=>$sealone->id])); ?>"><span class="btn label-primary">reject</span></a>
    ...
    <script type="text/javascript">
      $('document').ready(function () {
        $('.mshit').click(function () {
          ...
          axios.get('<?php echo e(route('seal03.rejectlog')); ?>',{
            params: {
              id: this.id
            }
          }).then(function (res) {
