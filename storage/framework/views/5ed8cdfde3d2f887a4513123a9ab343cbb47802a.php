    ...
    <div id="main_div" class="row">
     <div class="col-12">
       <div class="box">
        ...
        <form method="post" action="<?php echo e(route('labdip.store')); ?>" data-parsley-validate>
              ...
              <div class="form-group">
                ...
                <select v-model="proto" id="protoid" name="proto" class="form-control" required="" data-parsley-error-message="Select Proto">
                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($d->source_id); ?>"><?php echo e($d->proto); ?></option>
  ...
  var vm = new Vue({
    ...
    methods: {
      fetch_colors (proto_id) {
        var self = this
        axios.get('<?php echo e(route("labdip.colors")); ?>',{
            params: {
              id: this.proto
            }
          })
