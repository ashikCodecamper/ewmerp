    ...
    <div class="row">
     ...
     <div class="col-12">
     	 <div class="box">
            ...
            <form method="post" action="{{route('orderprocess.update',$orpro->id)}}" data-parsley-validate>
              {{csrf_field()}}
              ...
              <div class="row">
                ...
                <input type="text" name="porcvdate" value="{{$orpro->po_sheet_rcv}}" class="form-control" id="porcv">
               ...
               <select class="form-control" name="srcno" required data-parsley-error-message="Select Source No.">
                 ...
                 <option value="{{$src->source_id}}"{{$src->source_id==$orpro->srcno?'selected':''}}>{{$src->proto}}</option>
                 @endforeach
               </select>
                 <span class="text-danger"></span>
               </div>
          ...
          <div id="bul_container">
             ...
             <div class="row">
                 <div class="col-md-3">
                   <div class="form-group">
                     <label>Color</label>
                     <input type="text" name="color" class="form-control" required data-parsley-error-message="Enter Color Name or Code" value="{{$orpro->color}}">
                   </div>
                 ...
                 <div class="col-md-3">
                   <div class="form-group">
                     ...
                     <input type="text" name="qty" class="form-control" value="{{$orpro->quantity}}" required data-parsley-error-message="Enter Quantity">
                   </div>
                 </div>
                 ...
                 <div class="col-md-3">
                   <div class="form-group">
                     ...
                     <input type="text" class="form-control exfact" name="exfactdate" value="{{$orpro->ex_factory_date}}" required data-parsley-error-message="Select Date">
                   </div>
                 </div>
                 <div class="col-md-3">
                   <div class="form-group">
                     <label for="">Warehouse Date</label>
                     <input type="text" name="warehouse" value="{{$orpro->warehouse_date}}" class="form-control warehouse" readonly>
                   </div>
                 </div>
                </div>
                </div>
