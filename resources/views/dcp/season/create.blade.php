        ...
        <div class="col-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Create Season</h3>
            ...
            <div class="box-body no-padding">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <form class="" action="{{route('season.store')}}" method="post" data-parsley-validate>
                      {{csrf_field()}}
                      <div class="form-group">
                        <label for="">Season Name</label>
                        <input type="text" name="sea_name" value="{{old('sea_name')}}" class="form-control" required="" data-parsley-error-message="Enter Season Name">
                      </div>
