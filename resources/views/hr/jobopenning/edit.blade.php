...
<div class="row">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                    <form class="form" action="{{route('jobopenning.update',$jobopenning->id)}}" method="post" class="form">
                      {{csrf_field()}}
                      ...
                      <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="job_title" value="{{$jobopenning->job_title}}" class="form-control">
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <label class="col-form-label">Deadline</label>
                              <input type="text" name="job_deadline" value="{{$jobopenning->job_deadline}}" class="form-control datepicker">
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <label class="col-form-label">No of Vacancy</label>
                              <input type="text" name="job_vacancy" value="{{$jobopenning->job_vacancy}}" class="form-control">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="edu_req" value="{{$jobopenning->edu_req}}" class="form-control">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-form-label">Experience Requirements</label>
                                <input type="text" name="exp_req" value="{{$jobopenning->exp_req}}" class="form-control">
                              </div>
                          </div>
                        </div>
                        <div class="row">
