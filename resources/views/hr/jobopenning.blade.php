  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">New Job Openning</h5>
...
@endif
        ...
        {{csrf_field()}}
          <div class="form-group">
            ...
            <input type="text" required name="job_title" value="" class="form-control">
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="" class="col-form-label">Application Deadline</label>
                <input type="text" required name="job_deadline" value="{{ old('attend_dates') }}" class="form-control datepicker">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
          ...
          <div class="box">
                      ...
                      <div class="box-body pad">
                          <textarea name="job_desc" class="textarea" placeholder="Place job description here"
