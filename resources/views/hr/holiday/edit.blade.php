          ...
          <div class="box">
            ...
            <div class="box-body no-padding">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <form class="" action="{{route('holidaylist.update',$holiday->id)}}" method="post">
                      {{csrf_field()}}
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="start_date" value="{{$holiday->start_date}}" class="form-control datepicker">
                      </div>
                      <div class="form-group">
                        <label for="">End date</label>
                        <input type="text" name="end_date" value="{{$holiday->end_date}}" class="form-control datepicker">
                      </div>
