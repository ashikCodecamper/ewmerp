...
@section('content')
    <div class="row">
     <div class="col-md-12">
      ...
      <form class="" method="post" action="{{route('auditStore',$s->id)}}" enctype="multipart/form-data" data-parsley-validate>
        {{csrf_field()}}
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="smeta_date" class="form-control" value="" id="date-picker">
                </div>
            </div>
            <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="smeta_nextdate" class="form-control" value="" id="date-picker1">
                    </div>
            </div>
            <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required data-parsley-type="integer" name="smeta_cap" class="form-control" value="" >
                    </div>
            </div>
            <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="smeta_close" class="form-control" value="" id="date-picker2">
                    </div>
            </div>
        </div>
