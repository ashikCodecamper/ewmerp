          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools" style="float:right;">
                  ...
                  <a href="{{route('seal04.create')}}"><button type="buton" class="btn bg-purple btn-lg" ><strong>Add New Seal<strong></button></a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <table class="table">
                ...
                <tr>
                  ...
                  <td class="text-right">
                    @if ($sealone->status)
                      <a href="{{route('seal04.approve', ['id'=>$sealone->id])}}"><span class="btn label-warning">undo approve</span></a>
                    @else
                      <a href="{{route('seal04.edit', ['id'=>$sealone->id])}}"><span class="btn label-warning">edit</span></a>
                      <a href="{{route('seal04.approve', ['id'=>$sealone->id])}}"><span class="btn label-success">approve</span></a>
                      <a href="{{route('seal04.reject', ['id'=>$sealone->id])}}"><span class="btn label-primary">reject</span></a>
    ...
    <script type="text/javascript">
      $('document').ready(function () {
        $('.mshit').click(function () {
          ...
          axios.get('{{route('seal04.rejectlog')}}',{
            params: {
              id: this.id
            }
          }).then(function (res) {
