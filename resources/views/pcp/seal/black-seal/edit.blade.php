    ...
    <div class="row">
     ...
     <div class="col-12">
       <div class="box">
            ...
            <form method="post" action="{{route('seal02.editsave', ['id'=>$seal_ones->id])}}" data-parsley-validate>
              {{csrf_field()}}
        ...
        <div class="col-md-2">
          <div class="form-group">
             ...
             <select class="form-control" name="sealtype" required="" data-parsley-error-message="Select Seal Type">
               ...
               @if($seal_ones->seal_type == 'Black Seal')
                <option value="Black Seal" selected>Black Seal</option>
                <option value="Fit sample">Fit Sample</option>
               @else
                <option value="Fit sample" selected>Fit Sample</option>
