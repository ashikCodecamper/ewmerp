    ...
    <div class="row">
     ...
     <div class="col-12">
       <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools" style="float:right;">
                      <a href="{{route('seal01.index')}}"><button type="buton" class="btn bg-purple btn-lg" ><strong>List<strong></button></a>
              </div>
              <hr>
            </div>
            <form method="post" action="{{route('seal101.editsave', ['id'=>$seal_ones->id])}}" data-parsley-validate>
              {{csrf_field()}}
        ...
        <div class="col-md-2">
          <div class="form-group">
             ...
             <select class="form-control" name="sealtype" required="" data-parsley-error-message="Select Seal Type">
               ...
               @if($seal_ones->seal_type == 'RedSeal')
                <option value="RedSeal" selected>Red Seal</option>
                <option value="Dev.sample">Dev. Sample</option>
               @else
                <option value="Dev.sample" selected>Dev. Sample</option>
        ...
        <div class="col-md-2">
          <div class="form-group">
            ...
            <input  value="{{$seal_ones->plan_date}}" type="text" name="plandate" class="form-control plandate" required="" data-parsley-error-message="Enter Date" placeholder="YYYY-MM-DD" id="plandate">
          </div>
        ...
        <div class="col-md-2">
          ...
          <input value="{{$seal_ones->submission_date}}" placeholder="YYYY-MM-DD" type="text" name="actsum" id="actsubdate" class="form-control actsubdate" placeholder="YYYY-MM-DD" required="" data-parsley-error-message="Enter Date">
          </div>
       ...
       <div class="col-md-2" id="uardate">
        ...
        <textarea value="" placeholder="awb details" name="awb" rows="2" class="form-control" required="" data-parsley-error-message="Enter details" >
          {{$seal_ones->awb_details}}
        </textarea>
          </div>
        </div>
        ...
        <div class="col-md-2">
          <div class="form-group">
             ...
             <input value="{{$seal_ones->comment_date}}" placeholder="YYYY-MM-DD" type="text" name="cmntdate" id="cmntsdate" class="form-control cmntsdate" placeholder="YYYY-MM-DD" required="" data-parsley-error-message="Enter Date">
          </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
              <label>Remarks</label>
              <textarea value="" rows="1" cols="25" name="rev_comment" placeholder="Revised Comment">{{$seal_ones->rev_comment}}</textarea>
            </div>
        </div>
