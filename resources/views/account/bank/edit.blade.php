...
@section('content')
    ...
    <div class="row">
        <form class="col s12" method="post" action="{{route('bank.update',['id'=>$bank->id])}}">
            {{csrf_field()}}
            <div class="row">
                <div class="input-field col s6">
                    <i class="material-icons prefix">business</i>
                    <input value="{{$bank->bank_name}}" name="bank_name" id="icon_prefix" type="text" class="validate" required>
                    <label for="icon_prefix">Bank Name</label>
                </div>

                <div class="input-field col s6">
                    <i class="material-icons prefix">business</i>
                    <input value="{{$bank->branch_name}}" name="branch_name" id="icon_prefix" type="text" class="validate" required>
            ...
            <div class="row">
                <div class="input-field col s6">
                    ...
                    <input value="{{$bank->account_no}}" name="account_no" id="icon_prefix" type="text" class="validate" required>
                    <label for="icon_prefix">Account No</label>
                </div>

                <div class="input-field col s6">
                    <i class="material-icons prefix">account_balance</i>
                    <input value="{{$bank->address}}" name="address" id="icon_prefix" type="text" class="validate" required>
