...
class CreateExpensesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('expenses', function (Blueprint $table) {
           ...
           $table->foreign('subhead_id')->references('id')->on('account_sub_heads')->onDelete('cascade');  $table->foreign('subhead_id')->references('id')->on('account_sub_heads')->onDelete('cascade');
            $table->timestamps();
        });
    }
